...
const libraryEntryPoints = ["widget"];
const distEntryPoints = libraryEntryPoints.concat([
  "inline",
  "polyfills",
  "vendor",
  "sw-register",
    ...
    plugins: [
      ...
      new HtmlWebpackPlugin({
        ...
        chunksSortMode: function sort(left, right) {
          let leftIndex = distEntryPoints.indexOf(left.names[0]);
          let rightIndex = distEntryPoints.indexOf(right.names[0]);
